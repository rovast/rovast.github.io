  ...
  routes: [
    {
      path: "/",
      name: "add",
      component: () => __vitePreload(() => import("./HomeView.4a8a3e70.js"), true ? ["assets/HomeView.4a8a3e70.js","assets/ipfs.5ff68aef.js","assets/HomeView.ebb24b3f.css"] : void 0)
    },
    {
      path: "/:cid",
      name: "show",
      component: () => __vitePreload(() => import("./ContentView.569d7e9f.js"), true ? ["assets/ContentView.569d7e9f.js","assets/ipfs.5ff68aef.js","assets/ContentView.31c0e846.css"] : void 0)
    }
  ]
});
const normalize = "";
